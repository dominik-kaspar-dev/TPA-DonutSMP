...
if "%DOWNLOAD_URL%"=="" (
    set DOWNLOAD_URL=https://repo.maven.apache.org/maven2/org/apache/maven/apache-maven/3.9.0/apache-maven-3.9.0-bin.zip
)

powershell -Command "& '%DIRNAME%\.mvn\wrapper\MavenWrapperDownloader.ps1' -DownloadUrl '%DOWNLOAD_URL%' -TargetFile '%MAVEN_PROJECTBASEDIR%\.mvn\wrapper\maven-wrapper.jar'" ^
    || goto error
